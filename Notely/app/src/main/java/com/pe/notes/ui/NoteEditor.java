...
public class NoteEditor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHeader = (EditText) findViewById(R.id.note_heading);
        ...
        mUndoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //TODO : Enable undo only if there is change in previous and current content
                cancelNote();
            }
        });
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                updateNote(text, mHeader.getText().toString());
    ...
    private final void updateNote(String text, String title) {
        ...
        //values.put(NotePad.Notes.COLUMN_NAME_TITLE, mHeader.getText().toString());
